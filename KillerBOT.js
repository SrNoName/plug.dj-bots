...
(function() {
  ...
  pupOnline = function() {
    return API.sendChat(KillerBOT version 0.0.0 started);
  };
    ...
    cookieCommand.prototype.functionality = function() {
      ...
      if (msg.substring(7, 8) === "@") {
        ...
        if (user === false) {
          ...
          return API.sendChat(/em: "@" + user.username + ", @" + this.msgData.from + " has rewarded you with " + this.getCookie() + ". Enjoy.");
        }
      }
    };
